...
<Steps>
  ...
  <Step title="(Optional) Enable the GUI editor">
    Before clicking **Install**, check the **Install Py2Html GUI** checkbox if you want the visual editor. The GUI editor requires three additional packages:
    ...
    Install these yourself if the installer does not fetch them automatically:
  ...
  <Step title="Click Install and wait">
    ...
    2. Create the directory `~/py2html/` (i.e., `py2html/` inside your home folder).
